export default {
  ...
  conversation: {
    ...
    choosedLanguage: 'You choosed english language.',
    name: 'Your name',
    emptyInput: 'Name input is empty',
    pleaseFillInput: 'Please write your name!',
    niceToMeetYou: 'Nice to meet you, {name}!'
  },
  jumbotron: {
    nameAndSurname: 'Alexey Muzichenko',
  ...
  contactMePage: {
    contactMe: 'Contact me',
    contactMeUsing: 'Feel free to contact me on one of the following ways',
    ...
    yourMessagePlaceholder: 'Enter something...',
    submitBtn: 'Submit',
    resetBtn: 'Reset'
  }
}

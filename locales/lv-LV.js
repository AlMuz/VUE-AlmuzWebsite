export default {
  ...
  conversation: {
    ...
    choosedLanguage: 'Jūs izvēlējāties latviesu valodu.',
    name: 'Jusu vards',
    emptyInput: 'Vārda lauks ir tukšs',
    pleaseFillInput: 'Lūdzu, uzrakstiet savu vārdu!',
    niceToMeetYou: 'Priecājos ar jums iepazīties, {name}!'
  },
  jumbotron: {
    nameAndSurname: 'Aleksejs Muzičenko',
  ...
  contactMePage: {
    contactMe: 'Sazinies ar mani',
    contactMeUsing: 'Sazinieties ar mani, izmantojot vienu no šiem veidiem',
    orContactMeUsing: 'Vai arī varat nosūtīt man ziņojumu, izmantojot šo formu',
    yourEmail: 'Epasta adrese:',
    yourEmailPlaceholder: 'Ievadiet epastu',
    yourEmailDescription: 'Mēs nekad neizpaudīsim jūsu e-pastu nevienam citam.',
    yourName: 'Jūsu vārds:',
    yourNamePlaceholder: 'Ievadiet vārdu',
    yourMessage: 'Jūsu ziņa:',
    yourMessagePlaceholder: 'Ievadiet kaut ko ...',
    submitBtn: 'Iesniegt',
    resetBtn: 'Notīrīt formu'
  }
}
